<%-- 
    Document   : addRoomType
    Created on : Feb 27, 2022, 4:10:21 PM
    Author     : firem
--%>
        ...
        <section class="content-section">
            <c:if test="${requestScope.successful != null && requestScope.successful == 1}">
                <div class="successful">
                    <span>Tạo kiểu phòng trọ thành công.</span>
                    <a href="list">Nhấn vào đây để xem danh sách kiểu phòng vừa tạo</a>
                </div>
            </c:if>
            <div class="detail">
                <form class="detail-content" action="add" method="POST">
                    ...
                    <div class="detail-container">
                        ...
                        <input type="text" name="price" id="name" class="detail-input">
                    ...
                    <div class="detail-container">
                        ...
                        <input type="text" name="area" id="name" class="detail-input">
                        <c:if test="${requestScope.errorArea != null}">
                            </br><p class="detail-name-error">${requestScope.errorArea}</p>
                        </c:if>
                    </div>
                    <div class="detail-container">
                        <label for="name">Số lượng người ở</label>
                        <input type="text" name="quantity" id="name" class="detail-input">
